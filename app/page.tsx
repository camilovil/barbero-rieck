      ...
      <header className="fixed top-0 left-0 right-0 z-50 t-bg-2 backdrop-blur-sm border-b t-border" style={{background:'var(--bg-2)', borderColor:'var(--border)'}}>
        <div className="max-w-2xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <img src="/logo.png" alt="Santi Barber" width={44} height={44} className="rounded-full object-cover" style={{marginTop:'-12px', boxShadow:'0 0 0 3px #1a1a1a, 0 0 0 11px #F5E6C8'}} />
